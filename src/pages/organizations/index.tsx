...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'business_administrator.count', 'cargo.count', 'driver.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('business_administrator', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'business_administrator',
          header: 'Business Administrator',
          accessorKey: 'business_administrator',
          cell: ({ row: { original: record } }: any) => record?._count?.business_administrator,
        }
      : null,
    hasAccess('cargo', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'cargo',
          header: 'Cargo',
          accessorKey: 'cargo',
          cell: ({ row: { original: record } }: any) => record?._count?.cargo,
        }
      : null,
    hasAccess('driver', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Driver',
          accessorKey: 'driver',
          cell: ({ row: { original: record } }: any) => record?._count?.driver,
        }
      : null,
