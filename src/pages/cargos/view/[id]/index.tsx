...
import { getCargoById } from 'apiSdk/cargos';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('cargo', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/cargos/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Cargo Name" text={data?.cargo_name} />

                <FormListItem label="Cargo Weight" text={data?.cargo_weight} />

                <FormListItem label="Cargo Volume" text={data?.cargo_volume} />

                <FormListItem label="Cargo Type" text={data?.cargo_type} />
