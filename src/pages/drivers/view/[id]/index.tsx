...
import { getDriverById } from 'apiSdk/drivers';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('driver', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/drivers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Vehicle Type" text={data?.vehicle_type} />

                <FormListItem label="Vehicle Capacity" text={data?.vehicle_capacity} />
