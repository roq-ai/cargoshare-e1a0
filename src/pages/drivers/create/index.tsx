      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'vehicle_capacity',
              isInvalid: !!formik.errors?.vehicle_capacity,
            }}
            name="vehicle_capacity"
            error={formik.errors?.vehicle_capacity}
            value={formik.values?.vehicle_capacity}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('vehicle_capacity', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
