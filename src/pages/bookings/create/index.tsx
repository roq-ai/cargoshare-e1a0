...
function BookingCreatePage() {
  ...
  const formik = useFormik<BookingInterface>({
    initialValues: {
      ...
      status: '',
      cargo_id: (router.query.cargo_id as string) ?? null,
      shipping_agent_id: (router.query.shipping_agent_id as string) ?? null,
    },
    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <AsyncSelect<CargoInterface>
            formik={formik}
            name={'cargo_id'}
            label={'Select Cargo'}
            placeholder={'Select Cargo'}
            fetcher={getCargos}
            labelField={'cargo_name'}
          />
