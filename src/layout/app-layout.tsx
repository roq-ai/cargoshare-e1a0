...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['platform-owner', 'business-administrator', 'driver', 'shipping-agent'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Bookings', path: '/bookings', entity: 'booking', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
    {
      ...
      path: '/business-administrators',
      entity: 'business_administrator',
      service: AccessServiceEnum.PROJECT,
      icon: FiUserCheck,
    },
    { name: 'Cargos', path: '/cargos', entity: 'cargo', service: AccessServiceEnum.PROJECT, icon: FiPackage },
    { name: 'Drivers', path: '/drivers', entity: 'driver', service: AccessServiceEnum.PROJECT, icon: FiTruck },
